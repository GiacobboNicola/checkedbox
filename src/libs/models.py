...
class NGConvNet(nn.Module):
    def __init__(self, num_classes, in_gray):
        super(NGConvNet, self).__init__()
...
# reference: https://medium.com/analytics-vidhya/resnet-understand-and-implement-from-scratch-d0eb9725e0db
class ResNet18(nn.Module):
    def __init__(self, n_classes):
        ...
        self.concat_adjust_3 = nn.Conv2d(
            in_channels=64, out_channels=128, kernel_size=(1, 1), stride=(2, 2), padding=(0, 0)
        )
        ...
        self.concat_adjust_4 = nn.Conv2d(
            in_channels=128, out_channels=256, kernel_size=(1, 1), stride=(2, 2), padding=(0, 0)
        )
        ...
        self.concat_adjust_5 = nn.Conv2d(
            in_channels=256, out_channels=512, kernel_size=(1, 1), stride=(2, 2), padding=(0, 0)
        )
